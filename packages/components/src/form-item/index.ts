...
import { Tooltip as TTooltip, Icon as TIcon } from 'tdesign-vue-next'
...
const ICON_MAP = {
  info: () => h(TIcon, {}, { default: () => h(InfoFilled, {}, {}) }),
  error: () => h(TIcon, {}, { default: () => h(CircleClose, {}, {}) }),
  success: () => h(TIcon, {}, { default: () => h(CircleCheck, {}, {}) }),
  warning: () => h(TIcon, {}, { default: () => h(Warning, {}, {}) }),
}
