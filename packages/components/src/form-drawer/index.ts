...
import { Drawer as TDrawer, Button as TButton, Drawer } from 'tdesign-vue-next'
import type {
  DrawerProps as TDrawerProps,
...
type IFormDrawerProps = Omit<TDrawerProps, 'title'> & {
  title?: DrawerTitle
